...
def addMap(mapName, url, showJsonView, fileResponse, content):
    ...
    click2(Pattern("urlflIf.png").targetOffset(23,2))
    type2(url)
    if (showJsonView):
    ...
    click2(Pattern("IIkeyluaLUE.png").targetOffset(7,-1))
...
def createPost(mapName, url, fileResponse, content):
    ...
    type(Key.ENTER)
    doubleClick2("itemGetAllUser.png")
    click2(Pattern("urlflIf.png").targetOffset(22,1))
    type2(url)
    click2(Pattern("IImethodGET.png").targetOffset(19,0))
    type(Key.DELETE)
    type(Key.DELETE)
    type(Key.DELETE)
    type(Key.DELETE)
    type2("POST\",")
    click2(Pattern("PosrIImethod.png").targetOffset(56,1))
    type(Key.ENTER)
    type2("\"bodyPatterns\" : [{\n \"equalToJson\" : \"{\"Name\":\"User3\",\"Age\":60}\"\n}]") 
    click2(Pattern("IINameUser3A.png").targetOffset(-87,1))
    type(Key.END, KeyModifier.SHIFT)
    type(Key.LEFT, KeyModifier.SHIFT)
    #type(Key.LEFT, KeyModifier.SHIFT)
    rightClick2("Age60HIIName.png")
    click2("Json.png")
    click2("Escape.png")
    click2(Pattern("flflflNameUs.png").targetOffset(-109,-1))    
    type(Key.END, KeyModifier.SHIFT)
    type(Key.LEFT, KeyModifier.SHIFT)
    rightClick2("NameUser3Age-1.png")
    click2("Json.png")
    click2("Editvalue-1.png")
    click2(Pattern("Age60.png").targetOffset(6,2))
    type(Key.DELETE)
    type(Key.DELETE)
    type2("100")
    ...
    click2("btnClose.png")
    doubleClick2(fileResponse)
    click2(Pattern("IIkeyluaLUE-1.png").targetOffset(7,0))
    type("a", KeyModifier.CTRL)
    type2(content)
    rightClick2(Location(581, 207))
    click2("menuJson.png")
...
def compareTest():
    ...
    wait(1)
    click2(Pattern("close-1.png").targetOffset(44,-2))
    click2(Pattern("usernsert.png").targetOffset(31,-3))
    click2("Scenario1Sta.png")
    click2("btnClean.png")
    click2("WebRequest.png")    
    click2(Pattern("eelAge.png").targetOffset(14,2))
    type(Key.DELETE)
    type(Key.DELETE)
    type2("100")
    click2("execute.png")
...
def testCreateNotExistsAPI():
    addServer("server1", "")
    addMap("GetAllUser.json", "user/all", True, "responseGetAllUser.png", '[{"Name":"User1","Age":20},{"Name":"User2","Age":21}]')
    addMap("GetUser1.json", "user/1", False, "itemGetUser1.png", '{"Name":"User1","Age":20}')
    addMap("GetUser2.json", "user/2", False, "itemGetUser2.png", '{"Name":"User2","Age":50}')
    duplicateMap("user2GetUser-1.png", Location(145, 201), "GetUser2aite.png", "GetUser2-alternative.json", '{"Name":"User2","Age":50, "otherAttribute": 10}')
    createPost("InsertUser.json", "user/insert", "InsertUser.png", '{"status":"OK"}')
...
def testRecord():
    ...
    click2(Pattern("tit1eH3Schoo.png").targetOffset(-110,0))
    type(Key.END, KeyModifier.SHIFT)
...
def testProxy():
    ...
    type(Key.PAGE_UP)
    type(Key.PAGE_UP)
    click(Location(988, 246))
    keyDown(Key.CTRL)
    click(Location(1096, 269))
    click("Differenceof.png")
    wait(4)
    
def cleanChromeCache():
    click("chrome-1.png")
    click(Pattern("com.png").targetOffset(27,1))
    type(Key.DELETE, KeyModifier.CTRL + KeyModifier.SHIFT)
    wait(4)
    click2("LIMPARDADOSD.png")
    click2(Pattern("Jragoes.png").targetOffset(47,-2))
