...
def compareTest():
    ...
    click2("POST.png")
    click2(Pattern("urlWR.png").targetOffset(20,-2))
    paste2("http://localhost:5500/user/insert")
    click2(Pattern("BodyHeaderFi.png").targetOffset(-49,2))
    click2(Pattern("bodyWR.png").targetOffset(-20,21))
    paste2('{"Name":"User3","Age":60}')
    ...
    wait(4)
    click2("D0009Age60.png")
    wait(1)
    click2("closeCompare.png")
    click2(Pattern("closecomapre.png").targetOffset(33,-4))
    click2("Scenario1Sta.png")
    click2("btnClean.png")
    click2("WebRequest.png")
    click2(Pattern("HAgeH.png").targetOffset(6,1))
    type(Key.DELETE)
    type(Key.DELETE)
    type2("100")
    click2("execute.png")
    ...
    click2("closeCompare.png")
    click2(Pattern("closecomapre.png").targetOffset(33,-4))
    click2(Pattern("WebRequest.png").targetOffset(43,-1))
...
def testRecord():
    ...
    wait(2)
    click2(Pattern("ServerUrIhtt-1.png").targetOffset(265,0))
    wait(5)
    click2("close.png")
    click2(Pattern("rmagescolorp.png").targetOffset(-74,-1))
    doubleClick2("bodyimagesco.png")
    click2(Pattern("bodyimagesco-1.png").targetOffset(105,0))
    rightClick2("server2-1.png")
    click2("StOP.png")
    rightClick2("server2.png")
    click2("start.png")    
    click2(Pattern("mapp1ngno01.png").targetOffset(-55,0))
    doubleClick2("bodyro0f.png")
    click2(Pattern("titleW3Schoo.png").targetOffset(-81,-1))
    type(Key.END, KeyModifier.SHIFT)
    ...
    click2(Pattern("QCongurages.png").targetOffset(82,0))
    type(Key.F5)
    wait(3)
    click2("close.png")
    testShowInfo()
...
def testShowInfo():
    rightClick2(Pattern("server2httpo.png").targetOffset(17,10))
    click2("ShowName.png")
    wait(2)
